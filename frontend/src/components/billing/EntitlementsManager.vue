<template>
  <div class="entitlements-manager p-6">
    <!-- Header -->
    <div class="mb-6">
      ...
      >
        ...
        <div class="p-6">
          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <!-- Current Usage -->
            <div>
              <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Current Usage</h4>
              <div class="space-y-3">
                <div>
                ...
                <div class="text-xs text-gray-500 dark:text-gray-400 mt-2">
                  <Icon icon="ic:baseline-refresh" class="mr-1" />
                  Resets {{ getResetText(entitlement) }}
                </div>
              </div>
            </div>
            ...
            <div>
              <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Additional Information</h4>
          ...
          <div v-if="entitlement.usageHistory" class="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
            <h4 class="text-sm font-medium text-gray-700 dark:text-gray-300 mb-4">Usage Trend (Last 30 Days)</h4>
            <div class="h-32 flex items-center justify-center bg-gray-50 dark:bg-gray-700 rounded-lg">
              <div class="text-center text-gray-500">
                <Icon icon="ic:baseline-bar-chart" class="text-2xl mb-2" />
                <p class="text-sm">Usage chart will be displayed here</p>
              </div>
            </div>
          </div>
        </div>
...
import EntitlementDetailsModal from './EntitlementDetailsModal.vue'
import UpgradeEntitlementModal from './UpgradeEntitlementModal.vue'
...
const getResetText = (entitlement) => {
