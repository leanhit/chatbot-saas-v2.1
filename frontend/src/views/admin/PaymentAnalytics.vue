  ...
  <div class="p-6">
    <div class="flex justify-between items-center mb-6">
      <div class="flex items-center">
        ...
        <h1 class="text-2xl font-bold text-gray-800 dark:text-white">{{ $t('admin.analytics.title') }}</h1>
      </div>
    </div>
    ...
    <div v-else>
      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-6">
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div>
              <p class="text-sm text-gray-600 dark:text-gray-400">{{ $t('admin.analytics.monthlyRevenue') }}</p>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div>
              <p class="text-sm text-gray-600 dark:text-gray-400">{{ $t('admin.analytics.weeklyRevenue') }}</p>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div>
              <p class="text-sm text-gray-600 dark:text-gray-400">{{ $t('admin.analytics.successfulPayments') }}</p>
        ...
        <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
          <div class="flex items-center">
            ...
            <div>
              <p class="text-sm text-gray-600 dark:text-gray-400">{{ $t('admin.analytics.conversionRate') }}</p>
      ...
      <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6 mb-6">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">{{ $t('admin.analytics.trends') }}</h2>
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ $t('admin.analytics.totalPayments') }}</p>
            <p class="text-xl font-bold text-gray-800 dark:text-white">{{ dashboardData.trends?.totalPayments || 0 }}</p>
          </div>
          <div>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ $t('admin.analytics.success') }}</p>
            <p class="text-xl font-bold text-green-600 dark:text-green-400">{{ dashboardData.trends?.completedCount || 0 }}</p>
          </div>
          <div>
            <p class="text-sm text-gray-600 dark:text-gray-400">{{ $t('admin.analytics.failed') }}</p>
      ...
      <!-- Top Users -->
      <div class="bg-white dark:bg-gray-900 rounded-lg shadow p-6">
        <h2 class="text-lg font-semibold text-gray-800 dark:text-white mb-4">{{ $t('admin.analytics.topUsers') }}</h2>
