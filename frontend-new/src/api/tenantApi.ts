...
export const tenantApi = {
  ...
  // Address
  async updateTenantAddress(tenantId: string, addressId: string, data: AddressRequestDTO): Promise<{ data: any }> {
  ...
  // Basic Info
  async updateTenantBasicInfo(tenantId: string, data: TenantBasicInfoRequest): Promise<{ data: TenantDetailResponse }> {
