...
export const useAuthStore = defineStore('auth', () => {
  ...
  const login = async (authData) => {
    ...
    console.log('Login: setting user data:', authData.user);
    console.log('Login: userId from user:', authData.user?.id);
  ...
  const loginWithCredentials = async (credentials) => {
    ...
    try {
      ...
      try {
        ...
        console.error("Lỗi lấy Tenant nhưng vẫn cho login:", tenantErr)
      ...
      console.log('Skipping profile fetch during login - requires tenant context');
  ...
  const fetchUser = async () => {
    ...
    console.log('fetchUser: token exists, userId from store:', userId.value);
