...
public class PaymentMetricsAspect {
    ...
    @Around("execution(* com.chatbot.core.payment.transaction.service.SimplePaymentService.createDeposit(..))")
    ...
    @Around("execution(* com.chatbot.core.payment.transaction.service.SimplePaymentService.completePayment(..))")
    ...
    @Around("execution(* com.chatbot.core.payment.gateway.service.BankApiService.*(..))")
    ...
    @Around("execution(* com.chatbot.core.payment.gateway.service.QRCodeService.generateQRCode(..))")
