package com.chatbot.core.penny.service;
...
public class PennyBotCrudService {
    ...
    private final com.chatbot.core.penny.core.PennyMiddlewareEngine pennyMiddlewareEngine;
    private final com.chatbot.core.message.store.repository.ConversationRepository conversationRepository;
    private final com.chatbot.core.penny.security.InputSanitizer inputSanitizer;
    ...
    public String processMessage(UUID botId, String message, String userId, String ownerId, boolean isTestMode) {
        ...
        try {
            ...
            try {
                com.chatbot.core.penny.dto.request.MiddlewareRequest middlewareRequest = 
