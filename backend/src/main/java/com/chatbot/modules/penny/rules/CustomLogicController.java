...
public class CustomLogicController {
    ...
    public ResponseEntity<Map<String, Object>> testCustomLogic(
        ...
        try {
            ...
            com.chatbot.modules.penny.dto.request.MiddlewareRequest mockRequest = 
                com.chatbot.modules.penny.dto.request.MiddlewareRequest.builder()
            ...
            com.chatbot.modules.penny.context.ConversationContext mockContext = 
                com.chatbot.modules.penny.context.ConversationContext.builder()
            ...
            com.chatbot.modules.penny.routing.dto.IntentAnalysisResult mockIntent = 
                com.chatbot.modules.penny.routing.dto.IntentAnalysisResult.builder()
            ...
            com.chatbot.modules.penny.dto.response.MiddlewareResponse response = 
