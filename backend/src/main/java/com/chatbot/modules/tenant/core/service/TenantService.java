...
public class TenantService {
     ...
     */
        ...
        List<Long> tenantIds = tenantsPage.getContent().stream()
                .map(Tenant::getId)
                .collect(Collectors.toList());
        Map<Long, com.chatbot.modules.tenant.profile.dto.TenantProfileResponse> profilesMap = 
        ...
        return tenantsPage.map(tenant -> {
            ...
            com.chatbot.modules.tenant.profile.dto.TenantProfileResponse profile = 
    ...
    private void createEmptyTenantProfile(Tenant tenant) {
        ...
        com.chatbot.modules.tenant.profile.dto.TenantProfileRequest profileRequest = 
            new com.chatbot.modules.tenant.profile.dto.TenantProfileRequest();
