package com.chatbot.integrations.image.fileMetadata.controller;
...
public class FileMetadataController {
    ...
    /**
     * Serve file content through backend to avoid CORS issues
     * @param id: File ID
    ...
    public ResponseEntity<byte[]> getFileContent(@PathVariable String id) {
        try {
            byte[] fileContent = fileMetadataService.getFileContent(id);
            if (fileContent != null) {
    ...
    public ResponseEntity<byte[]> getPublicFileContent(@PathVariable String id) {
        try {
            byte[] fileContent = fileMetadataService.getFileContent(id);
            if (fileContent != null) {
                return ResponseEntity.ok()
